...
- (float) scoreAgainst:(NSString *)otherString{
    return [self scoreAgainst:otherString fuzziness:@(1)];
}
...
- (float)scoreAgainst:(NSString * _Nonnull)anotherString fuzziness:(NSNumber * _Nonnull)fuzziness options:(NSStringScoreOption)options{
